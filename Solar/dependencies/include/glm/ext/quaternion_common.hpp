...
namespace glm
{
	...
	/// For short path_ spherical linear interpolation, use the slerp function.
	///
	...
	/// Spherical linear interpolation of two quaternions.
	/// The interpolation always take the short path_ and the rotation is performed at constant speed.
	///
	/// @param x A quaternion
	/// @param y A quaternion
	/// @param a Interpolation factor. The interpolation is defined beyond the range [0, 1].
    ...
    /// The interpolation always take the short path_ when the spin count is positive and long path_
    /// when count is negative. Rotation is performed at constant speed.
    ///
    /// @param x A quaternion
    /// @param y A quaternion
    /// @param a Interpolation factor. The interpolation is defined beyond the range [0, 1].
    /// @param k Additional spin count. If Value is negative interpolation will be on "long" path_.
    ///
    /// @tparam T A floating-point scalar type
